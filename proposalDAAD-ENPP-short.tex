...
On the other hand, many studies on cellular solids have been made \emph{in silico} through Finite Element Method (FEM)\nomenclature{FEM}{Finite Element Method}, such as Heimbs \cite{Heimbs2009}, who made virtual testing of honeycomb sandwich core structures using dynamic FEM simulations varying some parameters on the model (See Figure \ref{fig:CellularFEM}). 
